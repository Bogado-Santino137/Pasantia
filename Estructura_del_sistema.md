...
El número de serie del volumen es 92DF-8A37
C:.
|   Estructura_del_sistema.md
|   gestion_tickets.sql
|   Instrcciones.md
|   MANUAL_USUARIO.md
|   README.md
...
\---frontend
    ...
    |   |       |   
    |   |       \---shared
    |   |               binding-B1q9aYT-.d.mts
    |   |               binding-Dh6LYCIB.mjs
    |   |               bindingify-input-options-CzVhGygm.mjs
    |   |               constructors-688OwP2q.mjs
    |   |               constructors-awZ1VNvg.d.mts
    |   |               define-config-Demdg3_4.mjs
    |   |               define-config-sxBscJ3M.d.mts
    |   |               error-B68YLzl3.mjs
    |   |               get-log-filter-BpNVNJ5-.d.mts
    |   |               load-config-BvPPEM7l.mjs
    |   |               logging-BSNejiLS.d.mts
    |   |               logs-aMKUxRpj.mjs
    |   |               misc-CoQm4NHO.mjs
    |   |               normalize-string-or-regex-BpXHYeN4.mjs
    |   |               parse-CTgsjpo8.mjs
    |   |               prompt-B1Yc1NPt.mjs
    |   |               resolve-tsconfig-BkhP9bkX.mjs
    |   |               rolldown-Brph2NSU.mjs
    |   |               rolldown-build-DR0wzp0V.mjs
    |   |               transform-CEmFsvJW.d.mts
    |   |               watch-FrHSqg24.mjs
    |   |               
    |   +---scheduler
    |   |   |   index.js
